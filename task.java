...
public class task {
	...
	public void AddUser() throws InterruptedException {
		...
		driver.findElement(By.id("systemUser_userName")).sendKeys("DavidMorris2");
	...
	public void SearchForUser() {
		...
		driver.findElement(By.xpath("//*[@id=\"menu_admin_viewAdminModule\"]/b")).click();
		driver.findElement(By.id("searchSystemUser_userName")).sendKeys("DavidMorris2");
	...
	public void UserDetails() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"btnSave\"]")).click();
		Thread.sleep(3000);
		String Employee = driver.findElement(By.xpath("//input[@id='systemUser_employeeName_empName']")).getAttribute("value");
